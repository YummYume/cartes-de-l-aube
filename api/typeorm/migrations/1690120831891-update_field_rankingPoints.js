export class UpdateFieldRankingPoints1690120831891 {
    name = 'UpdateFieldRankingPoints1690120831891'

    async up(queryRunner) {
        await queryRunner.query(`
            ALTER TABLE \`match_history_player\` CHANGE \`rankingPoint\` \`rankingPoints\` int NOT NULL
        `);
        await queryRunner.query(`
            ALTER TABLE \`user\` CHANGE \`rankingPoint\` \`rankingPoints\` int NOT NULL DEFAULT '0'
        `);
        await queryRunner.query(`
    ...
    async down(queryRunner) {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE \`user\` CHANGE \`rankingPoints\` \`rankingPoint\` int NOT NULL DEFAULT '0'
        `);
        await queryRunner.query(`
            ALTER TABLE \`match_history_player\` CHANGE \`rankingPoints\` \`rankingPoint\` int NOT NULL
        `);
    }
}
