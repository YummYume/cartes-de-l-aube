export class UpdateMatchHistoryPlayerTimestamp1690123106611 {
    name = 'UpdateMatchHistoryPlayerTimestamp1690123106611'
    ...
    async up(queryRunner) {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE \`match_history\` CHANGE \`startedAt\` \`startedAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
        `);
        await queryRunner.query(`
            ALTER TABLE \`match_history\` CHANGE \`endedAt\` \`endedAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
        `);
        await queryRunner.query(`
    ...
    async down(queryRunner) {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE \`match_history\` CHANGE \`endedAt\` \`endedAt\` timestamp NOT NULL
        `);
        await queryRunner.query(`
            ALTER TABLE \`match_history\` CHANGE \`startedAt\` \`startedAt\` timestamp NOT NULL
        `);
        await queryRunner.query(`
